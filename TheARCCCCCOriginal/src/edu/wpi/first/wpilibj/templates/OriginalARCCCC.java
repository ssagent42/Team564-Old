 ...
 * directory.
 */
public class OriginalARCCCC extends IterativeRobot {
    /**
...
//        flag = false;
    ...
    public void teleopPeriodic() {
       ...
       else if(arc.getRawButton(3)&& raptorforward.get()){//uses boolean to stop it every other button press
           raptorforward.set(false);
           raptorretract.set(false);
       }
       
       
       if(arc.getRawButton(4) && button4 == true){ //try if all else works
