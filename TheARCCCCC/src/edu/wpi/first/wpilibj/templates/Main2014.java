 ...
 * directory.
 */
public class Main2014 extends IterativeRobot {
    /**
    ...
    Joystick makeymakey;
    Servo swerve;
    DoubleSolenoid Tsolenoids;
    DoubleSolenoid swagger;
   ...
   // boolean flag;
    ...
    public Main2014(){
        ...
        winch1 = new Jaguar(3);
        winch2 = new Jaguar(4); 
      //  trexup = new Relay(6, Relay.Direction.kBoth);
        //trexdown = new Relay(1,6 ,Relay.Direction.kReverse);
        comp = new Compressor(2,4);
        arc = new Joystick(1);
        left = new Joystick(2);
        right = new Joystick(3);
        makeymakey = new Joystick(4);
        //compresspower = new Relay(4);
        //compresspower.set(Relay.Value.kOff);
        Tsolenoids= new DoubleSolenoid(3, 2);
        swagger = new DoubleSolenoid(4, 5);
    ...
    public void robotInit() {
        ...
        // swerve = new Servo();
          ...
          compON = comp.enabled();
          pressure = comp.getPressureSwitchValue();
